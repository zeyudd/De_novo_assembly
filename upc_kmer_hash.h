            ...
            shared [KMER_PACKED_LENGTH] char *heap_kmers, const unsigned char *kmer_to_add, char left_ext, char right_ext)
{
   ...
   upc_memput(&heap_kmers[pos * KMER_PACKED_LENGTH], packedKmer, KMER_PACKED_LENGTH * sizeof(char));
   ...
   unpackSequence(&heap_kmers[pos * KMER_PACKED_LENGTH], unpackedKmer, KMER_LENGTH);
